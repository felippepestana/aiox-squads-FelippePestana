...
Sentry.io → Issues → Deve aparecer vazio
...
1. GA4 → Real-time → Users
2. Abra http://localhost:8787 no browser
3. Deve aparecer "1 active user" ✅
