...
- 🟢 **Camada de orquestração construída:** o squad [`apex-talent`](squads/apex-talent/) costura os 11 módulos via tasks (`route-need`, `map-lifecycle`, `consolidate-cross-module`) e workflows cross-módulo (`wf-employee-lifecycle`, `wf-hire-to-onboard`, `wf-retention-loop`) — o que torna a plataforma uma plataforma, e não 11 squads soltos.
