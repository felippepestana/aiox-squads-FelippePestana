...
- 🟢 **Controle de ponto construído:** [`chronos`](squads/chronos/) (registro multimodal, escalas dinâmicas, banco de horas, detecção de anomalias de jornada, alertas preventivos) — 6 agentes (T0→T3), tasks, templates, checklist e workflow, com gate de conformidade CLT/eSocial e princípio de jornada rastreável e auditável.
- 🟢 **Treinamento & desenvolvimento construído:** [`academy`](squads/academy/) (mapeamento de gaps cruzando performa/org-architect, trilhas 70-20-10, conteúdo e avaliações, certificações) — 6 agentes (T0→T3), tasks, templates, checklist e workflow, com gate pedagógico (precisão, objetivos mensuráveis, acessibilidade) e princípio de medir aplicação no trabalho — não vaidade de conclusão.
- 🟢 **People analytics construído:** [`insights`](squads/insights/) (dashboards determinísticos, turnover/burnout preditivo, auditoria de diversidade, narrativas executivas) — 6 agentes (T0→T3), tasks, templates, checklist e workflow, com gate de ética/privacidade (LGPD, tamanho mínimo de grupo, impacto desproporcional) e princípio de predição como alerta precoce — nunca veredito contra a pessoa.
- 🟢 **Benefícios construído:** [`benefits-hub`](squads/benefits-hub/) (catálogo, elegibilidade, recomendação personalizada, condução de adesão, análise de custo vs. adoção) — 6 agentes (T0→T3), tasks, templates, checklist e workflow, com gate de consentimento/privacidade (dado de saúde minimizado, sigilo das escolhas) e princípio de o melhor benefício é o que cabe na vida da pessoa agora.
- 🟢 **Camada de orquestração construída:** [`apex-talent`](squads/apex-talent/) (costura dos 11 módulos via tasks e workflows cross-módulo) — tasks (`route-need`, `map-lifecycle`, `consolidate-cross-module`) e workflows (`wf-employee-lifecycle`, `wf-hire-to-onboard`, `wf-retention-loop`), o que torna a plataforma uma plataforma, e não 11 squads soltos.
