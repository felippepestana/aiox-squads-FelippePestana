...
Consolida todos os outputs em relatório final Markdown estruturado e salva no workspace via `Write`. Suporta dois modos: `MODO_PROCESSUAL` para processos genéricos e `MODO_JURIDICO` para processos judiciais ou estratégicos.
...
1. Detecte o modo (`MODO_PROCESSUAL` ou `MODO_JURIDICO`) pelo pacote recebido
