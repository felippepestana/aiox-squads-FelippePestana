...
- §1º: As partes serão intimadas da nomeação do perito
- §2º: Prazo mínimo de 15 dias para indicação de assistentes técnicos e formulação de quesitos

**Art. 466.** O perito cumprirá escrupulosamente o encargo que lhe foi cometido, independentemente de termo de compromisso.
- §1º: Dever de imparcialidade e fidelidade técnica
- §2º: Comunicação de impedimentos (Arts. 148, 144 e 145)
...
**Art. 477.** O perito pode ser substituído quando:
- I - faltar conhecimento técnico ou científico
- II - sem motivo legítimo, deixar de cumprir o encargo no prazo

**Art. 479.** O juiz apreciará a prova pericial de acordo com o disposto no art. 371, indicando na sentença os motivos que o levaram a considerar ou a dispensar, no todo ou em parte, as conclusões do laudo.

### Perito (Arts. 156-158)

**Art. 156.** O juiz será assistido por perito quando a prova do fato depender de conhecimento técnico ou científico.
- §1º: O perito será escolhido entre profissionais de nível universitário, devidamente inscritos no órgão de classe competente
- §2º: Os peritos serão nomeados entre profissionais com experiência comprovada (Lei 8.906/1994)

**Art. 157.** O perito tem o dever de cumprir o ofício e prestar o compromisso de bem e fielmente desempenhar o encargo.

**Art. 158.** O perito que, por dolo ou culpa, prestar informações inverídicas responderá pelos prejuízos que causar à parte e ficará inabilitado para atuar em outras perícias por 2 a 5 anos.
...
- §1º: Prazo de 30 dias para sanar o vício (produtos não duráveis) ou 90 dias (produtos duráveis)
- §2º: Poderá ser imediatamente exigida: I - substituição; II - restituição; III - abatimento proporcional

**Art. 26.** O direito de reclamar pelos vícios aparentes ou de fácil constatação caduca em:
- I - 30 dias (produtos não duráveis)
- II - **90 dias (produtos duráveis)** ← aplicável a iPhones

**Art. 27.** Prescreve em **5 anos** a pretensão à reparação pelos danos causados por fato do produto ou do serviço.
...
- Seção 4: Requisitos estruturais
- Seção 5: Requisitos de recursos (pessoal, instalações, equipamentos)
- Seção 6: Requisitos de processo (análise de contratos, seleção de métodos, amostragem)
- Seção 7: Requisitos do sistema de gestão
- **Aplicação pericial:** O laboratório/perito deve demonstrar competência técnica e imparcialidade
...
- Procedimentos de identificação, coleta, aquisição e preservação
- **Aplicação pericial:** Preservação do estado do dispositivo como evidência

### ABNT NBR 5410:2004
**Instalações elétricas de baixa tensão**
- Relevante para avaliação de carregadores e tomadas
...
- **Aplicação pericial:** Avaliação de conformidade do produto

### Resolução ANATEL nº 680/2017
- Aprovação de uso de produtos de telecomunicações (certificação ANATEL)
- Verificação do número ANATEL no dispositivo periciado
- **Aplicação pericial:** Verificar se o dispositivo é produto aprovado para o Brasil
...
## Estrutura Normativa do Laudo

Conforme **ABNT NBR ISO/IEC 17025:2017, Seção 7.8** (Relatório de resultados), o laudo deve conter:

1. Título (identificação como laudo técnico pericial)
2. Nome e endereço do laboratório/perito
3. Identificação única do relatório (número)
4. Nome e contato do cliente (processo judicial)
5. Descrição e identificação do item ensaiado (dispositivo)
6. Data de recebimento e de realização dos ensaios
7. Referência ao plano de amostragem (método de diagnóstico)
8. Resultados com unidades de medida
9. Incertezas de medição (quando aplicável)
10. Assinatura e título do responsável técnico
...
- Análise jurídica das responsabilidades (fabricante, importador, assistência técnica)
