# Referências Normativas — Perícia Judicial em iPhone
...
| Art. 12, §3º, II | Excludente de responsabilidade | Dano causado por terceiro (ex: assistência) |
| Art. 12, §3º, III | Excludente de responsabilidade | Uso inadequado pelo consumidor |
| Art. 14 | Responsabilidade pelo fato do serviço | Assistência técnica responde por danos |
...
| Art. 50 | Garantia contratual | Complementar à garantia legal |
...
| Resolução CFT nº 1.010/2005 | Atribuições profissionais | Define competências do engenheiro eletricista/eletrônico |
...
**Aplicação:** Define os requisitos para que um laboratório ou perito demonstre competência técnica e imparcialidade na realização de ensaios.
...
**Aplicação:** Cadeia de custódia do dispositivo como evidência eletrônica.

**Princípios fundamentais (Seção 5):**
- **Relevância:** Só coletar evidências pertinentes ao caso
- **Confiabilidade:** Procedimentos reprodutíveis e auditáveis
- **Suficiência:** Quantidade adequada de evidências para sustentar as conclusões
- **Auditabilidade:** Documentação de todos os passos
...
**Aplicação:** Avaliação de conformidade dos carregadores e tomadas utilizados. Parâmetros de tensão e corrente esperados em instalações domésticas brasileiras (127V/220V, 60Hz).
...
- Proteção de acessórios de carga (conectores USB)

### 2.5 IEC 60529:2013
**Título:** Degrees of protection provided by enclosures (IP Code)  
**Aplicação:** Verificação do grau de proteção IP68 declarado para o iPhone 16 Pro Max.

**IP68 (iPhone 16 Pro Max — declaração Apple):**
- 6 = Proteção total contra poeira (IP6X)
- 8 = Imersão até 6 metros por 30 minutos (IPX8 — Condições Apple)
- *Nota: Apple declara IP68 sob condições controladas de laboratório. Resistência diminui com o desgaste e uso.*
...
| IEC 60068-2-78 | Calor úmido (Damp heat) | Resistência à umidade |
| IEC 60068-2-27 | Choque mecânico | Resistência a impactos |
| IEC 60068-2-6 | Vibração | Resistência a vibrações |

---

## 3. Padrões e Especificações Técnicas Apple

### 3.1 USB Power Delivery (USB PD 3.0 / IEEE 802.3bt)
- Tensões negociadas: 5V, 9V, 15V, 20V
- iPhone 16 Pro Max — carga rápida: até 27W (9V / 3A)
- Protocolo de negociação: via pinos CC1/CC2 do conector USB-C

### 3.2 MagSafe / Qi2
- Potência máxima: 25W (iPhone 16 Pro Max com MagSafe 25W)
- Frequência: 127,7 kHz (Qi2)
- Alinhamento magnético: sistema de ímãs permanentes (Array MagSafe Apple)

### 3.3 Apple MFi Program
- MFi = Made for iPhone/iPad/iPod
- Acessórios certificados MFi garantem compatibilidade e segurança
- Carregadores não MFi podem causar danos ao dispositivo e invalidar garantia

### 3.4 Apple Global Service Exchange (GSX)
- Base de dados de serviços Apple
- Registra todos os serviços realizados por AASP (Apple Authorized Service Provider)
- Contém status de garantia, número de série, modelo exato e histórico de reparos
...
- Número de homologação: gravado na carcaça ou impresso na embalagem
- Verificação: sistemas.anatel.gov.br/sch/

### 4.2 INMETRO
- **Portaria nº 170/2012:** Regulamento técnico de qualidade para adaptadores de corrente alternada para uso em equipamentos de tecnologia da informação
- Aplicável aos carregadores (adaptadores USB-C) fornecidos com o iPhone

### 4.3 Resolução RDC ANVISA (quando aplicável)
- Para casos envolvendo danos por aquecimento excessivo (risco à saúde/segurança)
- Baterias de lítio: risco de incêndio em caso de dano físico (thermal runaway)
...
### 5.2 Certificações Apple Recomendadas (não obrigatórias por lei, mas indicadas)

| Certificação | Emissor | Descrição |
|---|---|---|
| ACMT | Apple | Apple Certified Mac Technician |
| ACiT | Apple | Apple Certified iOS Technician |
| ASF | Apple | Apple Service Fundamentals |

*Nota: As certificações Apple são recomendadas para demonstrar expertise técnica específica, mas não substituem o registro profissional no CREA, que é o requisito legal para emissão de laudo técnico pericial.*
