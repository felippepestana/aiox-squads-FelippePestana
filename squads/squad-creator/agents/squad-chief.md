...
# Structure validation: cite worker-backed tasks so validate-squad-structure does not flag them as orphans
worker_task_registry_refs:
  description: >-
    Base tasks invoked by workflows, *sync, or quality gates. Listed for T2-ORP-001 only; do not remove without updating tasks/.
  cited_task_files:
    - tasks/auto-heal.md
    - tasks/create-documentation.md
    - tasks/detect-operational-mode.md
    - tasks/detect-squad-context.md
    - tasks/install-commands.md
    - tasks/operational-test.md
    - tasks/qa-after-creation.md
    - tasks/reexecute-squad-phase.md
    - tasks/setup-runtime.md
