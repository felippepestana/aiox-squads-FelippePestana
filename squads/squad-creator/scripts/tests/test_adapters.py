...
PRO_SCORING_SCRIPT = (BASE_SCRIPTS / "../../squad-creator-pro/scripts/scoring.py").resolve()
PRO_COHERENCE_SCRIPT = (BASE_SCRIPTS / "../../squad-creator-pro/scripts/coherence-validator.py").resolve()
...
@pytest.mark.skipif(
    not PRO_SCORING_SCRIPT.is_file(),
    reason="squad-creator-pro scoring.py not present in this checkout",
)
...
@pytest.mark.skipif(
    not PRO_COHERENCE_SCRIPT.is_file(),
    reason="squad-creator-pro coherence-validator.py not present in this checkout",
)
