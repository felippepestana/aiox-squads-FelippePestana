...
3. **Delegar** ao Hardware Specialist o diagnóstico físico/eletrônico (incluindo Knox e-FUSE, ADB, ODIN)
4. **Delegar** ao Legal-Normative Specialist a verificação normativa (incluindo análise jurídica do Knox Warranty Void Flag)
...
- Registrar o status do **Knox Warranty Void Flag** (0x0 = íntegro; 0x1 = acionado) como item obrigatório do exame
...
[ ] Objeto da perícia identificado (marca, modelo, IMEI, número de série)
...
[ ] Status Knox e-FUSE a ser verificado durante o exame físico
```
...
- Status do Knox Warranty Void Flag documentado e interpretado juridicamente
