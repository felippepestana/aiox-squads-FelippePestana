...
show_status() {
  ...
  echo "  2. Clonar o projeto:       git clone git@github.com:felippepestana/aiox-squads-felippepestana.git"
  echo "  3. Instalar deps:          cd aiox-squads-felippepestana && cd web && npm install && cd ../chatbot && npm install"
